...
This is a minimal reproducible example for a godot-cpp issue.

## The issue

godot-cpp on godot 4.5 beta5 commit, errors out during compilation when using `gdextension_dir` scons flag and using the gdextension interface and api json generated by Godot 4.2.

See issue https://github.com/godotengine/godot-cpp/issues/1833
